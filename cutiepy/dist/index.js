...
const Button2 = props => {
  ...
  const [aAfterLeftBtn2, setAAfterLeftBtn2] = React.useState('51%');
...
const Button6 = props => {
  ...
  const [aBeforeBoxShadowBtn6, setABeforeBoxShadowBtn6] = React.useState('-100px 0 0 ' + color1);
  const [aBeforeTransformBtn6, setABeforeTransformBtn6] = React.useState('translateY(-50%)');
  const [aOpacityBtn6, setAOpacityBtn6] = React.useState('0');
  const [aAfterRightBtn6, setAAfterRightBtn6] = React.useState('0%');
  const [aAfterBoxShadowBtn6, setAAfterBoxShadowBtn6] = React.useState('100px 0 0 ' + color1);
  const [aAfterTransformBtn6, setAAfterTransformBtn6] = React.useState('translateY(-50%)');
...
exports.Button5 = Button5;
exports.Button6 = Button6;
exports.Button7 = Button7;
exports.Button8 = Button8;
